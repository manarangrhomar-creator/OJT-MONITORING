...
from .views import OJTProgramViewSet, OJTApplicationViewSet, AttendanceViewSet, CoordinatorDashboardViewSet, SiteAssignmentViewSet, SiteApprovalViewSet
...
router.register(r'site-approvals', SiteApprovalViewSet, basename='site-approval')
